...
Revision ID: c96c2ac62539
Revises: 
Create Date: 2025-01-09 14:10:39.347418
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('admin', 'user', 'auditor', name='user_roles'), nullable=True),
